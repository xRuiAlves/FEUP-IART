...
\begin{itemize}
    \item A student attends an event in the last timeslot of the day. For each student that attends an event in the last timeslot of the day, a penalty of value 1 is assigned.
